...
export default function StoryTypingChallenge() {
  ...
  return (
    <div className="min-h-screen bg-white flex flex-col p-6">
      ...
      {/* Header */}
      <div className="text-[35px] font-bold text-[#5C5E81] tracking-wide mb-1">
        TypeToTale
      </div>
      <div className="text-[#8C8DA3] text-sm mb-4">
        <Link to="/" className="hover:underline">Bookshelf</Link> &gt; <span className="font-semibold">create a story</span>
      </div>
