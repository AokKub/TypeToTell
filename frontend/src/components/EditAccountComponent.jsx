...
export default function UserEditAcc() {
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-[#8AA0BD] via-[#7B94B3] to-[#6B87A8] flex items-center justify-center p-4 relative overflow-hidden">
      ...
      {showSuccess && (
        <div className="fixed top-6 right-6 bg-green-500 text-white p-4 rounded-lg shadow-lg flex items-center gap-2 z-50 animate-in slide-in-from-right-full duration-300">
          <CheckCircle size={20} />
      ...
      {/* Main content */}
      <div className="bg-white/95 backdrop-blur-sm rounded-3xl shadow-2xl p-8 w-full max-w-6xl mt-20 md:mt-10 relative z-10">
        ...
        <div className="flex md:flex-row flex-col items-start md:gap-12 gap-8">
          ...
          <div className="flex-shrink-0 md:mx-0 mx-auto">
            <div className="relative group">
              <div
                className={`w-52 h-52 bg-gradient-to-br from-gray-100 to-gray-200 rounded-full overflow-hidden flex items-center justify-center shadow-lg border-4 transition-all duration-300 ${isDragging
          ...
          <div className="flex-1 space-y-6 w-full md:mt-6">
            ...
            <div className="space-y-6 p-6 bg-gray-50 rounded-xl">
              ...
              <div className="space-y-2">
                ...
                <input
                  ...
                  className={`w-full px-4 py-4 font-light text-[16px] bg-white rounded-lg border-2 transition-all duration-200 focus:outline-none ${errors.username
              ...
              <div className="space-y-2">
                ...
                <input
                  ...
                  onChange={handleInputChange}
                  className={`w-full px-4 py-4 font-light text-[16px] bg-white rounded-lg border-2 transition-all duration-200 focus:outline-none ${errors.email
                      ? "border-red-300 focus:border-red-500 focus:ring-2 focus:ring-red-200"
                      : "border-gray-200 focus:border-[#5C5E81] focus:ring-2 focus:ring-[#5C5E81]/20"
                    }`}
                />
            ...
            <div className="flex flex-col sm:flex-row gap-4 pt-6">
              <button
                ...
                className={`flex items-center justify-center gap-2 px-8 py-3 rounded-full font-medium text-[16px] transition-all duration-300 shadow-lg hover:shadow-xl ${isSubmitting || !hasUnsavedChanges
              ...
              <button
                ...
                className={`flex items-center justify-center gap-2 px-8 py-3 rounded-full font-medium text-[16px] transition-all duration-300 shadow-lg hover:shadow-xl ${!hasUnsavedChanges || isSubmitting
