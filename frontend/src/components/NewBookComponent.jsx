...
export default function NewBookComponent() {
  ...
  const handleStartStory = async () => {
    ...
    try {
      ...
      const response = await axiosInstance.post(`secure/generate-story/${userId}`, { theme: storyInput.trim() });
            ...
            <div className="relative z-10">
              ...
              <div className="mt-8 text-center">
                <p className="text-sm text-[#8C8DA3] leading-relaxed">
                  💡 <strong>Pro tip:</strong> Try words like "mystery", "friendship", or "dragons" for exciting stories!
                </p>
              </div>
            </div>
          </motion.div>
