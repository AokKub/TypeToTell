...
export default function CompleteStoryComponent() {
  ...
  const [profileImage, setProfileImage] = useState("/"); // Default profile image path
  useEffect(() => {
    const fetchStoryData = async () => {
      try {
        ...
        // Make API call to get completed story
        const response = await axiosInstance.get(
          `/secure/complete-story/${id}`,
        );
        console.log("Story data fetched:", response.data);
  ...
  const handleSaveStory = async () => {
    try {
      // Optional: Add any save logic here if needed
      // For now, just navigate to bookshelf
  ...
  if (loading) {
    return (
      <div className="min-h-screen bg-gradient-to-br from-slate-50 to-indigo-50 flex justify-center items-center">
    ...
    <div className="min-h-screen bg-gradient-to-br from-slate-50 via-white to-indigo-50 flex flex-col relative overflow-hidden">
      ...
      <div className="flex flex-col flex-grow pr-5 pb-13 pl-5 md:pt-13 lg:pt-13 relative z-10">
        ...
        <div className="flex flex-1 justify-center items-center px-5 mt-5">
          <div className="bg-gradient-to-br from-[#838FAF] to-[#6B7AA3] text-white rounded-3xl w-full max-w-[900px] h-auto p-8 shadow-2xl border border-white/20 backdrop-blur-sm relative overflow-hidden">
            ...
            <div className="relative z-10">
              ...
              <div className="text-center mb-8">
                ...
                <h2 className="text-3xl sm:text-4xl font-bold mb-3 bg-gradient-to-r from-white to-blue-100 bg-clip-text text-transparent">
                  Story Complete!
                </h2>
                <p className="text-base sm:text-lg mb-6 opacity-90 max-w-md mx-auto leading-relaxed">
                  Congratulations! Your creative journey has reached its perfect
                  ending.
                </p>
              </div>
